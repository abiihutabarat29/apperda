...
class DataFile extends BaseController
{
    ...
    public function data()
    {
        ...
        $perda = $this->fileModel->where('id_instansi =', $id)->findAll();
        $data = array(
            'title' => 'Data Perda',
            'data' => $perda,
    ...
    {
        $perda = $this->fileModel->where('jenis_perda =', 'Propemperda')->orwhere('jenis_perda =', 'Non-Propemperda')->findAll();
        $data = array(
    ...
    {
        $perda = $this->fileModel->where('status =', 3)->orwhere('status =', 4)->orwhere('status =', 5)->findAll();
        $data = array(
    ...
    public function edit($id)
    {
        ...
        $data = array(
            ...
            'validation' => \Config\Services::validation(),
            'data' => $this->fileModel->where('id', $id)->where('id_instansi', $idi)->first(),
        );
        return view('admin/layout/wrapper', $data);
    }
    ...
    {
        $perda = $this->fileModel->where('status', 0)->where('id =', $id)->first();
        $data = array(
    ...
    {
        $perda = $this->fileModel->where('id =', $id)->where('status =', 1)->first();
        $data = array(
    ...
    {
        $perda = $this->fileModel->where('status =', 3)->where('id =', $id)->first();
        $data = array(
            'titlebar' => 'Verifikasi Perda',
            'title' => 'Verifikasi Perda',
            'data' => $perda,
    ...
    {
        $perda = $this->fileModel->where('id =', $id)->first();
        $data = array(
    ...
    {
        $perda = $this->fileModel->where('status =', 2)->orwhere('status =', 3)->orwhere('status =', 4)->orwhere('status =', 5)->findAll();
        $data = array(
            'title' => 'Verifikasi Perda',
            'data' => $perda,
    ...
    {
        $perda = $this->fileModel->where('status =', 2)->where('id =', $id)->first();
        $data = array(
            'titlebar' => 'Verifikasi Perda',
            'title' => 'Verifikasi Perda',
            'data' => $perda,
