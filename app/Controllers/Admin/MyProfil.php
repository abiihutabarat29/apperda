...
class MyProfil extends BaseController
{
    ...
    public function myprofil()
    {
        ...
        $data = array(
            ...
            'title' => 'Profil Saya',
            'data' => $profil,
            'isi' => 'admin/master/myprofil/data',
        );
    ...
    public function edit($id)
    {
        ...
        $data = array(
            ...
            'isi' => 'admin/master/myprofil/edit',
    ...
    public function update($id)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to(base_url('/admin/my-profil/edit/' . $this->request->getPost('id')))->withInput();
        }
        ...
        return redirect()->to(base_url('admin/my-profil'));
    }
}
