...
class DataInstansi extends BaseController
{
    ...
    public function data()
    {
        ...
        $data = array(
            'title' => 'Data instansi',
            'data' => $datainstansi,
            'isi' => 'admin/master/instansi/data'
        );
    ...
    public function save()
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/admin/data-instansi/add')->withInput();
        }
        $data = [
        ...
        return redirect()->to(base_url('admin/data-instansi'));
    }
    ...
    public function edit($id)
    {
        $data = array(
            ...
            'isi' => 'admin/master/instansi/edit',
            'validation' => \Config\Services::validation(),
    ...
    public function update($id)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to(base_url('admin/data-instansi/edit/' . $this->request->getPost('id')))->withInput();
        }
        $data = [
            'id'             => $id,
            'instansi'       => $this->request->getPost('instansi'),
