...
class User extends BaseController
{
    ...
    public function save()
    {
        ...
        return redirect()->to(base_url('admin/data-user'));
    }
    ...
    public function update($id)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to(base_url('admin/data-user/edit/' . $this->request->getPost('id')))->withInput();
        }
        $md5 = md5($this->request->getPost('password'));
        $password = password_hash($md5, PASSWORD_DEFAULT);
        $data = [
