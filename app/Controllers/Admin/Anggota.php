...
class Anggota extends BaseController
{
    ...
    public function save()
    {
        if (!$this->validate([
            ...
            return redirect()->to('/admin/data-anggota/add')->withInput();
        }
        ...
        return redirect()->to(base_url('admin/data-anggota'));
    }
    ...
    public function update($id)
    {
        if (!$this->validate([
            ...
            return redirect()->to(base_url('/admin/data-anggota/edit/' . $this->request->getPost('id')))->withInput();
        }
        $foto   = $this->request->getFile('foto');
        if ($foto->getError() == 4) {
            $data = $this->anggotaModel->find($id);
