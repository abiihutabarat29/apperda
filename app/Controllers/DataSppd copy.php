...
class DataSppd extends BaseController
{
    ...
    public function datasub($id)
    {
        ...
        // $datasub = $this->spjsubModel->join('mod_spj_sppd', 'mod_spj_sppd.id = mod_spj_subkegiatan.id_kegiatan', 'left')->where('mod_spj_subkegiatan.id_bagian =', $idb)->where('mod_spj_subkegiatan.id_kegiatan =', $id)->findAll();
        // $datasub = $this->spjsubModel->where('id_bagian =', $idb)->where('id_kegiatan =', $id)->findAll();
        // dd($datasub);
        $data = array(
