        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <a href="<?= base_url('data-kegiatan/add') ?>" class="btn btn-primary btn-round ml-auto btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <a href="/data-kegiatan/edit/<?= $r['id']; ?>" class="btn btn-link btn-primary btn-lg">
...
<?php foreach ($data as $r) { ?>
    <form action="<?= base_url('data-kegiatan/' . $r['id']); ?>" method="post">
        <?= csrf_field(); ?>
