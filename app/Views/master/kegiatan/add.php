    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <form action="<?= base_url('data-kegiatan/save') ?>" method="post">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('kode_kegiatan')) ? 'has-error' : ''; ?>">
                                <label>Kode Kegiatan<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="kode_kegiatan" autocomplete="off" value="<?= old('kode_kegiatan'); ?>">
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('nama_kegiatan')) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" name="nama_kegiatan" autocomplete="off" value="<?= old('nama_kegiatan'); ?>">
                                <small class="form-text text-danger">
