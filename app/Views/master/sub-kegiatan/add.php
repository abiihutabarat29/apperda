    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <form action="<?= base_url('data-sub-kegiatan/save') ?>" method="post">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('id_kegiatan')) ? 'has-error' : ''; ?>">
                                ...
                                <select name="id_kegiatan" id="id-kegiatan" class="js-example-language" style="width: 100%">
                                    <option selected disabled><?= (old('id_kegiatan')) ? old('id_kegiatan') : ".::Pilih Kegiatan::." ?></option>
                        ...
                        <input type="hidden" class="form-control" id="kodekegiatan" name="kode_kegiatan">
                        <input type="hidden" class="form-control" id="namakegiatan" name="nama_kegiatan">
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('kode_sub')) ? 'has-error' : ''; ?>">
                                <label>Kode Sub Kegiatan<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="kode_sub" autocomplete="off" value="<?= old('kode_sub'); ?>">
                                <small class="form-text text-danger">
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('nama_sub')) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" name="nama_sub" autocomplete="off" value="<?= old('nama_sub'); ?>">
                                <small class="form-text text-danger">
