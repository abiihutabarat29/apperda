        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <a href="<?= base_url('data-sub-kegiatan/add') ?>" class="btn btn-primary btn-round ml-auto btn-sm">
                    ...
                    <!-- <div class="input-group-append">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#" data-toggle='modal' data-target='#modal-import'><i class="fas fa-upload"></i> Upload File</a>
                            <a class=" dropdown-item" href="<?= base_url() ?>/media/format/format-sub-kegiatan.xlsx" target="blank"><i class="fas fa-file-excel"></i> Download Example</a>
                        </div>
                    </div> -->
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <a href="/data-sub-kegiatan/edit/<?= $r['id']; ?>" class="btn btn-link btn-primary btn-lg">
...
<?php foreach ($data as $r) { ?>
    <form action="<?= base_url('data-sub-kegiatan/' . $r['id']); ?>" method="post">
        <?= csrf_field(); ?>
...
<div class="modal fade" id="modal-import" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Import Data Sub Kegiatan</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="<?= base_url('sub-kegiatan/import') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <div class="col-md-12">
