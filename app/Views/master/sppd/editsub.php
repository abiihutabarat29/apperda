<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="<?= base_url('sppd/sub-kegiatan/' . $data['id_kegiatan']) ?>"><?= $titlebar ?></a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav nav-pills nav-primary" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Sub Kegiatan</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <form action="<?= base_url('sppd/update-sub-kegiatan/' . $data['id']) ?>" method="post">
                        <?= csrf_field(); ?>
                        ...
                        <div class="tab-content mt-2 mb-3" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-detail" role="tabpanel" aria-labelledby="pills-detail-tab">
                                ...
                                <div class="card-action">
                                    ...
                                    <a href="<?= base_url('sppd/sub-kegiatan/' . $data['id_kegiatan']) ?>" class="btn btn-dark btn-sm"><i class="fas fa-undo-alt"></i> Kembali</a>
                                </div>
                            </div>
                        </div>
                    </form>
