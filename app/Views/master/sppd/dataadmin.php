                                            ...
                                            <td>
                                                <center>
                                                    <div class="form-button-action">
                                                        <a href="/data-sppd/verifikasi/<?= $r['id']; ?>" class="btn btn-info btn-xs mr-2">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <div class="form-button-action">
                                                        <a href="/data-sppd/review/<?= $r['id']; ?>" class="btn btn-info btn-xs mr-2">
                                                            <i class="fas fa-eye"></i>&nbsp;&nbsp;Review
                                                        </a>
                                                        <a href="/data-sppd/export-excel/<?= $r['id']; ?>" class="btn btn-dark btn-xs mr-2">
