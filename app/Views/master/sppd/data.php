        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <a href="<?= base_url('sppd/add') ?>" class="btn btn-primary btn-round ml-auto btn-sm">
                                    ...
                                    <td>
                                        <center>
                                            <div class="form-button-action">
                                                <?php if ($r['status'] == 0) { ?>
                                                    <a href="/sppd/sub-kegiatan/<?= $r['id']; ?>" class="btn btn-info btn-xs mr-2">
                                                        <i class="fas fa-plus"></i> Sub
                                                    </a>
                                                    <a href="/sppd/edit/<?= $r['id']; ?>" class="btn btn-primary btn-xs mr-2">
                                                ...
                                                <?php } elseif ($r['status'] == 1) { ?>
                                                    ...
                                                    <a href="/sppd/file/<?= $r['id']; ?>" class="btn btn-warning btn-xs mr-2">
...
<?php foreach ($data as $r) { ?>
    <form action="<?= base_url('sppd/' . $r['id']); ?>" method="post">
        <?= csrf_field(); ?>
