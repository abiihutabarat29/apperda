    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <form action="<?= base_url('data-kode-rekening/save') ?>" method="post">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('kode_rek')) ? 'has-error' : ''; ?>">
                                <label>Kode Rekening<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="kode_rek" autocomplete="off" value="<?= old('kode_rek'); ?>">
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('nama_rek')) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" name="nama_rek" autocomplete="off" value="<?= old('nama_rek'); ?>">
                                <small class="form-text text-danger">
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('kode_rek_simda')) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" name="kode_rek_simda" autocomplete="off" value="<?= old('kode_rek_simda'); ?>">
                                <small class="form-text text-danger">
