    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <form action="<?= base_url('data-anggaran/update/' . $data['id']); ?>" method="post">
                    <?= csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('anggaran')) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" id="anggaran" name="anggaran" autocomplete="off" value="<?= (old('anggaran')) ? old('anggaran') : $data['jumlah_anggaran']; ?>">
                                <small class="form-text text-danger">
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('tahun')) ? 'has-error' : ''; ?>">
                                <select name="tahun" class="form-control">
                                    <option><?= (old('tahun')) ? old('tahun') : $data['thn_anggaran'] ?></option>
