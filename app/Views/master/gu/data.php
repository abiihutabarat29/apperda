        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <a href="<?= base_url('data-gu/add') ?>" class="btn btn-primary ml-auto btn-round btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <a href="/data-gu/edit/<?= $r['id']; ?>" class="btn btn-link btn-primary btn-lg">
...
<?php foreach ($data as $r) { ?>
    <form action="<?= base_url('data-gu/' . $r['id']); ?>" method="post">
        <?= csrf_field(); ?>
