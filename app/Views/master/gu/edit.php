    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <form action="<?= base_url('data-gu/update/' . $data['id']); ?>" method="post">
                    <?= csrf_field(); ?>
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('gu')) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" name="gu" autocomplete="off" value="<?= (old('gu')) ? old('gu') : $data['judul']; ?>">
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('mulai')) ? 'has-error' : ''; ?>">
                                ...
                                <input type="date" class="form-control" name="mulai" autocomplete="off" value="<?= (old('mulai')) ? old('mulai') : $data['tgl_mulai']; ?>">
                                <small class="form-text text-danger">
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('jmulai')) ? 'has-error' : ''; ?>">
                                ...
                                <input type="time" class="form-control" name="jmulai" autocomplete="off" value="<?= (old('jmulai')) ? old('jmulai') : $data['jam_mulai']; ?>">
                                <small class="form-text text-danger">
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('selesai')) ? 'has-error' : ''; ?>">
                                ...
                                <input type="date" class="form-control" name="selesai" autocomplete="off" value="<?= (old('selesai')) ? old('selesai') : $data['tgl_selesai']; ?>">
                                <small class="form-text text-danger">
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?= ($validation->hasError('jselesai')) ? 'has-error' : ''; ?>">
                                ...
                                <input type="time" class="form-control" name="jselesai" autocomplete="off" value="<?= (old('jselesai')) ? old('jselesai') : $data['jam_selesai']; ?>">
                                <small class="form-text text-danger">
