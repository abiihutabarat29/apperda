            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    if ($kegiatan['status'] != 3) { ?>
                        <a href="<?= base_url('kegiatan/add-file/' . $kegiatan['id']) ?>" class="btn btn-primary btn-round ml-auto btn-sm">
                            <i class="fa fa-plus"></i>
                        </a>
                        <a href="<?= base_url('kegiatan') ?>" class="btn btn-dark btn-round btn-sm ml-2">
                            <i class="fas fa-undo-alt"></i> Kembali
                        </a>
                    <?php } else { ?>
                        <a href="<?= base_url('kegiatan') ?>" class="btn btn-dark btn-round btn-sm ml-auto">
                            <i class="fas fa-undo-alt"></i> Kembali
                        </a>
                    <?php } ?>
                </div>
                    ...
                    <table id="add-row" class="display table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%">
                                    <center>Pesanan Barang</center>
                                </th>
                                <th style="width: 20%">
                                    <center>Bon Faktur</center>
                                </th>
                                <th style="width: 10%">
                                    <center>
                                        Action
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="<?= base_url() ?>/media/berita-acara/<?= $r['berita_acara']; ?>" target="blank"><button class="btn btn-info btn-xs"><i class="fa fa-download"></i>&nbsp;&nbsp;Berita Acara</button></a>
                                        </center>
                                    </td>
                                    <td>
                                        <center>
                                            <a href="<?= base_url() ?>/media/pesanan-barang/<?= $r['pesanan_brg']; ?>" target="blank"><button class="btn btn-info btn-xs"><i class="fa fa-download"></i>&nbsp;&nbsp;Pesanan Barang</button></a>
                                        </center>
                                    </td>
                                    <td>
                                        <center>
                                            <a href="<?= base_url() ?>/media/bon-faktur/<?= $r['bon_faktur']; ?>" target="blank"><button class="btn btn-info btn-xs"><i class="fa fa-download"></i>&nbsp;&nbsp;Bon Faktur</button></a>
                                        </center>
                                    </td>
                                    <td>
                                        <center>
...
<?php foreach ($data as $r) { ?>
    <form action="<?= base_url('kegiatan/file/' . $r['id']); ?>" method="post">
        <?= csrf_field(); ?>
