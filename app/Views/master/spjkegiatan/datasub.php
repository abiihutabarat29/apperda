            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    if ($kegiatan['status'] != 3) { ?>
                        <a href="<?= base_url('kegiatan/add-sub-kegiatan/' . $kegiatan['id']) ?>" class="btn btn-primary btn-round ml-auto btn-sm">
                                        ...
                                        <center>
                                            <div class="form-button-action">
                                                <?php if ($kegiatan['status'] == 1) { ?>
                                                    <a href="/kegiatan/edit-sub-kegiatan/<?= $r['id']; ?>" class="btn btn-primary btn-xs mr-2">
...
<?php foreach ($data as $r) { ?>
    <form action="<?= base_url('kegiatan/sub-kegiatan/' . $r['id']); ?>" method="post">
        <?= csrf_field(); ?>
