...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?= base_url(); ?>/template/assets/img/icon-logo.png" />
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="<?= base_url('auth/verify') ?>" method="POST">
                            <?= csrf_field(); ?>
                            <div class="mb-3">
