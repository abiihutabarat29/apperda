        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <a href="<?= base_url('admin/slideshow/add') ?>" class="badge badge-primary btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a href="<?= base_url('admin/slideshow/edit/' . $value['id']); ?>" class="btn btn-primary btn-xs mr-2" title="Edit Data">
...
<?php foreach ($data as $key => $value) { ?>
    <form action="<?= base_url('admin/slideshow/' . $value['id']); ?>" method="post">
        <?= csrf_field(); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Apa kamu yakin ingin menghapus data <span class="text-danger"><?= $value['keterangan'] ?></span> ini secara permanen ???
                    </div>
