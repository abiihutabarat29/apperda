        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <a href="<?= base_url('admin/data-anggota/add') ?>" class="badge badge-primary btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a href="<?= base_url('admin/data-anggota/edit/' . $value['id']); ?>" class="btn btn-primary btn-xs mr-2" title="Edit Data">
...
<?php foreach ($data as $key => $value) { ?>
    <form action="<?= base_url('admin/data-anggota/' . $value['id']); ?>" method="post">
        <?= csrf_field(); ?>
