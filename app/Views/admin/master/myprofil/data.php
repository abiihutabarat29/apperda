            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="<?= base_url('admin/my-profil/edit/' . $data['id']) ?>" class="btn btn-warning ml-auto mr-2 btn-sm">
                                <i class="fa fa-edit"></i> Edit
                            </a>
                            <a href="<?= base_url('admin/home') ?>" class="btn btn-default ml-lg-1 btn-sm"><i class="fa fa-undo-alt"></i> Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
