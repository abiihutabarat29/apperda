<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="<?= base_url('admin/pengajuan-perda') ?>"><?= $titlebar ?></a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav nav-pills nav-primary nav-pills-no-bd" id="pills-tab-without-border" role="tablist">
                        ...
                        <li class="nav-item submenu">
                            <a class="nav-link" id="pills-contact-tab-nobd" data-toggle="pill" href="#pills-contact-nobd" role="tab" aria-controls="pills-contact-nobd" aria-selected="true">Hasil Verifikasi</a>
                        </li>
                    </ul>
                                    ...
                                    <div class="table-responsive table-hover table-sales">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td>
                                                    <?= $data['jenis_perda']; ?>
                                                    <button class="btn btn-link btn-success btn-sm p-0 mb-1">
                                        ...
                                        <br>
                                        <a href="<?= base_url('admin/pengajuan-perda') ?>" class="btn btn-dark btn-sm"><i class="fas fa-undo-alt"></i>&nbsp;&nbsp;Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </div>
