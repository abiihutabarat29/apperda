        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('admin/profil/update/' . $data['id']) ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                                ...
                                <div class="card-body">
                                    <div class="col-md-6">
                                        <div class="form-group <?= ($validation->hasError('nmapp')) ? 'has-error' : ''; ?>">
                                            ...
                                            <input type="text" class="form-control" name="nmapp" autocomplete="off" value="<?= (old('nmapp')) ? old('nmapp') : $data['nama_app']; ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group <?= ($validation->hasError('linkapp')) ? 'has-error' : ''; ?>">
                                            ...
                                            <input type="text" class="form-control" name="linkapp" autocomplete="off" value="<?= (old('linkapp')) ? old('linkapp') : $data['link_app']; ?>">
                                            <small class="form-text text-danger">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group <?= ($validation->hasError('deskripsi')) ? 'has-error' : ''; ?>">
                                            ...
                                            <textarea type="text" class="form-control" name="deskripsi" autocomplete="off"><?= (old('deskripsi')) ? old('deskripsi') : $data['deskripsi_app']; ?></textarea>
                                            <small class="form-text text-danger">
                                ...
                                <div class="card-body">
                                    <div class="col-md-6">
                                        <div class="form-group <?= ($validation->hasError('alamat')) ? 'has-error' : ''; ?>">
                                            ...
                                            <textarea type="text" class="form-control" name="alamat" autocomplete="off"><?= (old('alamat')) ? old('alamat') : $data['alamat']; ?></textarea>
                                            <small class="form-text text-danger">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group <?= ($validation->hasError('email')) ? 'has-error' : ''; ?>">
                                            ...
                                            <input type="text" class="form-control" name="email" autocomplete="off" value="<?= (old('email')) ? old('email') : $data['email']; ?>">
                                            <small class="form-text text-danger">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group <?= ($validation->hasError('telp')) ? 'has-error' : ''; ?>">
                                            ...
                                            <input type="text" class="form-control" name="telp" autocomplete="off" value="<?= (old('telp')) ? old('telp') : $data['nohp']; ?>">
                                            <small class="form-text text-danger">
                            ...
                            <div class="tab-pane fade" id="pills-icon" role="tabpanel" aria-labelledby="pills-icon-tab">
                                <div class="card-body">
                                    <div class="col-md-6">
                                        <div class="col-md-12">
                                            <div class="col-md-4">
                                                <img src="<?= base_url('media/icon/' . $data['icon']) ?>" alt="image profile" class="img-thumbnail rounded img-preview">
                                            </div>
